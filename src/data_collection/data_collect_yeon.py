...
# box 데이터 프레임 불러오기
guide_box_df = pd.read_csv("C:/Users/user/potenup/Korean-Sign-Language-Project/data/guide_box.csv")
sign_code_df = pd.read_csv("C:/Users/user/potenup/Korean-Sign-Language-Project/data/sign_code.csv")
...
hands = mp_hands.Hands(
    ...
    min_tracking_confidence = 0.4 # 트래킹 확률 0.5이상만
)
...
print("========================================")
# s 키를 누르면 저장됩니다!
file_path = f'C:/Users/user/potenup/Korean-Sign-Language-Project/data/sign_data/sign_data_{answer_label}.csv'
######### 🚨 여기를 수정하면 됩니다! 🚨 ########
##############################################
